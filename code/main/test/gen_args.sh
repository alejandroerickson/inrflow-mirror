...
then
		GDCFICONNL3="gdcficonn_3_4_0 gdcficonn_3_4_1 gdcficonn_3_14_2"
else
		GDCFICONNL3=""
fi
GDCFICONNL3_ROUTING="gdcficonn-proxy_1_3 gdcficonn-dimensional"
...
do
		...
		do
				...
				do
						for P in ${PATTERNS}
						do
								echo "topo=${T} failure_rate=${F} routing=${R} tpattern=${P} generate_bfs=false compile_latex=false placement=sequential rseed=$RANDOM"
...
then
    GDCFICONNL2="gdcficonn_2_35_0 gdcficonn_2_35_1 gdcficonn_2_70_2"
		# " gdcficonn_2_7_0 gdcficonn_2_7_1 gdcficonn_2_8_2"
else
		GDCFICONNL2=""
fi
GDCFICONNL2_ROUTING="gdcficonn-proxy_0_2 gdcficonn-dimensional"
for i in `seq 1 100`; do

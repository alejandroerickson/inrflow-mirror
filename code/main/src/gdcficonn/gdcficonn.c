...
long param_k;	///< parameter k of the topology, number of levels of the gdcficonn (-1)
long param_n;	///< parameter n of the topology, switch radix
long param_t; ///< tightness parameter.  must be 0<=param_t < param_k
...
//static bool_t tight_proxy;///< tight_proxy == TRUE if the condition for choosing a candidate
													///D_{m-1}^c is at level 0, and otherwise it is at level 1
...
list_t route_list; ///< this the list that proxy_routing will append to on the top level
...
/*
	static char *topo_stat_names[16]={"min.n.proxies",
																	"max.n.proxies",
																	"mean.n.proxies",
																	"median.n.proxies",
																	"var.n.proxies",
																	...
																	"var.savings",
																	"std.savings",
																	"n.proxies.per.success",
																	"n.proxies.per.non.success",
																	"success.rate"};
*/
